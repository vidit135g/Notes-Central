 ...
 */
package com.absolute.android.notescentral.receiver;
...
import com.absolute.android.notescentral.SnoozeActivity;
import com.absolute.android.notescentral.db.DbHelper;
import com.absolute.android.notescentral.services.NotificationListener;
...
import com.absolute.android.notescentral.utils.ParcelableUtil;
...
import com.absolute.android.notescentral.utils.notifications.NotificationChannels;
import com.absolute.android.notescentral.utils.notifications.NotificationsHelper;
...
public class AlarmReceiver extends BroadcastReceiver {
  ...
  private void createNotification (Context mContext, Note note) {
    ...
    snoozeIntent.setAction(ConstantsBase.ACTION_SNOOZE);
    snoozeIntent.putExtra(ConstantsBase.INTENT_NOTE, (android.os.Parcelable) note);
    ...
    postponeIntent.setAction(ConstantsBase.ACTION_POSTPONE);
    postponeIntent.putExtra(ConstantsBase.INTENT_NOTE, (android.os.Parcelable) note);
    ...
    intent.setAction(ConstantsBase.ACTION_NOTIFICATION_CLICK + System.currentTimeMillis());
